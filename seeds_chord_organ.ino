...
const uint8_t chords[][4] = { // An array of chords, each number is a note with a ratio to the root of n:64.
  { 64, 32, 64, 128},   // 8ves
  { 64, 64, 64, 64},    // unison
  { 64, 85, 114, 152},  // 4ths
  { 64, 96, 128, 171},  // sus4
  { 64, 96, 128, 160},  // major
  { 64, 96, 120, 160},  // major 7th
  { 64, 96, 115, 160},  // dominant 7th
  { 64, 96, 115, 154},  // minor 7th
  { 64, 96, 120, 154},  // minor major 7th
  { 64, 100, 125, 156},  // stacked major 3rds
};
...
void loop()
{
    ...
    case chord_mode:
      ...
      chord_phase_inc_1 = (( (uint32_t)(m_phase_inc) * chords[current_chord][1]) >> 6);
      chord_phase_inc_2 = (( (uint32_t)(m_phase_inc) * chords[current_chord][2]) >> 6) + 1;
      chord_phase_inc_3 = (( (uint32_t)(m_phase_inc) * chords[current_chord][3]) >> 6) - 1;
      chord_phase_inc_4 = (( (uint32_t)(m_phase_inc) * chords[current_chord][4]) >> 6) + 2;
