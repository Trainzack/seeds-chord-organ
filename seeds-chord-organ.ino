...
//comment out this line (by putting "//" in front of it) to enable just intonation for the chords
//in sound 9. The default is using equal temperament, which makes the chords less in tune with 
//themselves but more in tune with other notes.
#define EQUAL_TEMPERAMENT
...
// An array of chords, each number is a note with a ratio to the root of n/2^chord_ratio_exponent.
// In equal temperment (and with a ratio exponent of 8), the number of semitones above the root take on the following values:
//0:  256  1:   271  2:   287  3:   304  4:   323  5:   342  6:   362  7:   384  8:   406  9:   431  10:  456  11:  483  
//12: 512  13:  542  14:  575  15:  609  16:  645  17:  683  18:  724  19:  767  20:  813  21:  861  22:  912  23:  967
const uint8_t num_chords = 10;

#ifdef EQUAL_TEMPERAMENT
...
void chordProcess()
{
  ...
  output = (chord_phase_1 >> 10) + (chord_phase_2 >> 10) + (chord_phase_3 >> 10) + (chord_phase_4 >> 10);
